...
const WorldCanvasV7 = memo(function WorldCanvasV7({service,resourcePacks,visualExperiment,environmentStyle,worldSeed,terrainGenerationVersion,constructionFeedback=0,focusedProjectId,onSelectProject,onClearWorldFocus}:{service:ApplicationService;resourcePacks:ResourcePackRepository;visualExperiment:VoxelVisualExperiment;environmentStyle:WorldEnvironmentStyle;worldSeed:string;terrainGenerationVersion:3;constructionFeedback?:number;focusedProjectId:string|null;onSelectProject:(projectId:string)=>void;onClearWorldFocus:()=>void}) {
